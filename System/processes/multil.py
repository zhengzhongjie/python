"""
multiprocess basics: Process works threading.Thread, but
run function call in parallel in a process instead of a thread;
locks can be used to synchronize, e.g. prints on some platforms;
srarts new interpreter on windows, forks a new process on unix;
"""
