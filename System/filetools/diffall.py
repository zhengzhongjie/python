...
def comparetress(dir1, dir2, diffs, verbose=False):
	print('-' * 20)
	...
	for name in missed:
		difs.append('files missed at %s - %s: %s' % (dir1, dir2, name))
		print(name, 'DIFFERS')

if __name__ == '__main__':
	dir1, dir2 = dirdiff.getargs()
	diffs = []
	comparetress(dir1, dir2, diffs, True)
	print('-' * 40)
	if not diffs:
